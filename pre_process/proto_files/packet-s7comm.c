...
{ S7COMM_ROSCTR_JOB,                    "Job" },
{ S7COMM_ROSCTR_ACK,                    "Ack" },
{ S7COMM_ROSCTR_ACK_DATA,               "Ack_Data" },
...
#define S7COMM_AREA_DATARECORD              0x01
#define S7COMM_AREA_SYSINFO                 0x03
#define S7COMM_AREA_SYSFLAGS                0x05
#define S7COMM_AREA_ANAIN                   0x06
#define S7COMM_AREA_ANAOUT                  0x07
#define S7COMM_AREA_P                       0x80
#define S7COMM_AREA_INPUTS                  0x81
#define S7COMM_AREA_OUTPUTS                 0x82
#define S7COMM_AREA_FLAGS                   0x83
#define S7COMM_AREA_DB                      0x84
#define S7COMM_AREA_DI                      0x85
#define S7COMM_AREA_LOCAL                   0x86
#define S7COMM_AREA_V                       0x87
#define S7COMM_AREA_COUNTER                 28
#define S7COMM_AREA_TIMER                   29
#define S7COMM_AREA_COUNTER200              30
#define S7COMM_AREA_TIMER200                31
...
#define S7COMM_SYNTAXID_S7ANY               0x10
#define S7COMM_SYNTAXID_SHORT               0x11
#define S7COMM_SYNTAXID_EXT                 0x12
#define S7COMM_SYNTAXID_PBC_ID              0x13
#define S7COMM_SYNTAXID_ALARM_LOCKFREESET   0x15
#define S7COMM_SYNTAXID_ALARM_INDSET        0x16
#define S7COMM_SYNTAXID_ALARM_ACKSET        0x19
#define S7COMM_SYNTAXID_ALARM_QUERYREQSET   0x1a
#define S7COMM_SYNTAXID_NOTIFY_INDSET       0x1c
#define S7COMM_SYNTAXID_NCK                 0x82
#define S7COMM_SYNTAXID_NCK_METRIC          0x83
#define S7COMM_SYNTAXID_NCK_INCH            0x84
#define S7COMM_SYNTAXID_DRIVEESANY          0xa2
#define S7COMM_SYNTAXID_1200SYM             0xb2
#define S7COMM_SYNTAXID_DBREAD              0xb0
...
#define S7COMM_BLOCKTYPE_OB                 0x3038
#define S7COMM_BLOCKTYPE_CMOD               0x3039
#define S7COMM_BLOCKTYPE_DB                 0x3041
#define S7COMM_BLOCKTYPE_SDB                0x3042
#define S7COMM_BLOCKTYPE_FC                 0x3043
#define S7COMM_BLOCKTYPE_SFC                0x3044
#define S7COMM_BLOCKTYPE_FB                 0x3045
#define S7COMM_BLOCKTYPE_SFB                0x3046
...
#define S7COMM_UD_FUNCGROUP_SEC             0x05
#define S7COMM_UD_FUNCGROUP_PBC_BSEND       0x06
...
{ S7COMM_UD_FUNCGROUP_CYCLIC,           "Cyclic services" },
...
{ S7COMM_UD_SUBF_TIS_TIMEMEAS,          "Time measurement from to" },
...
{ 0x0601,                               "Code address area with call environment" },
{ 0x0700,                               "Data address" },
...
{ S7COMM_UD_SUBF_CPU_MSGS,              "Message service" },
{ S7COMM_UD_SUBF_CPU_DIAGMSG,           "Diagnostic message" },
{ S7COMM_UD_SUBF_CPU_ALARM8_IND,        "ALARM_8 indication" },
{ S7COMM_UD_SUBF_CPU_NOTIFY_IND,        "NOTIFY indication" },
{ S7COMM_UD_SUBF_CPU_ALARM8LOCK,        "ALARM_8 lock" },
{ S7COMM_UD_SUBF_CPU_ALARM8UNLOCK,      "ALARM_8 unlock" },
{ S7COMM_UD_SUBF_CPU_SCAN_IND,          "SCAN indication" },
{ S7COMM_UD_SUBF_CPU_AR_SEND_IND,       "AR_SEND indication" },
{ S7COMM_UD_SUBF_CPU_ALARMS_IND,        "ALARM_S indication" },
{ S7COMM_UD_SUBF_CPU_ALARMSQ_IND,       "ALARM_SQ indication" },
{ S7COMM_UD_SUBF_CPU_ALARMQUERY,        "ALARM query" },
{ S7COMM_UD_SUBF_CPU_ALARMACK,          "ALARM ack" },
{ S7COMM_UD_SUBF_CPU_ALARMACK_IND,      "ALARM ack indication" },
{ S7COMM_UD_SUBF_CPU_ALARM8LOCK_IND,    "ALARM lock indication" },
{ S7COMM_UD_SUBF_CPU_ALARM8UNLOCK_IND,  "ALARM unlock indication" },
...
#define S7COMM_TIA1200_VAR_ITEM_AREA1_DB    0x8a0e
#define S7COMM_TIA1200_VAR_ITEM_AREA1_IQMCT 0x0000
...
static gint hf_s7comm_tia1200_item_reserved1 = -1;
static gint hf_s7comm_tia1200_item_area1 = -1;
static gint hf_s7comm_tia1200_item_area2 = -1;
static gint hf_s7comm_tia1200_item_area2unknown = -1;
static gint hf_s7comm_tia1200_item_dbnumber = -1;
static gint hf_s7comm_tia1200_item_crc = -1;
static gint hf_s7comm_tia1200_substructure_item = -1;
static gint hf_s7comm_tia1200_var_lid_flags = -1;
static gint hf_s7comm_tia1200_item_value = -1;
static gint hf_s7comm_header = -1;
static gint hf_s7comm_header_protid = -1;
static gint hf_s7comm_header_rosctr = -1;
static gint hf_s7comm_header_redid = -1;
static gint hf_s7comm_header_pduref = -1;
static gint hf_s7comm_header_parlg = -1;
static gint hf_s7comm_header_datlg = -1;
static gint hf_s7comm_header_errcls = -1;
static gint hf_s7comm_header_errcod = -1;
static gint hf_s7comm_param = -1;
static gint hf_s7comm_param_errcod = -1;
static gint hf_s7comm_param_service = -1;
static gint hf_s7comm_param_itemcount = -1;
static gint hf_s7comm_param_data = -1;
static gint hf_s7comm_param_neg_pdu_length = -1;
static gint hf_s7comm_param_setup_reserved1 = -1;
static gint hf_s7comm_param_maxamq_calling = -1;
static gint hf_s7comm_param_maxamq_called = -1;
static gint hf_s7comm_param_item = -1;
static gint hf_s7comm_param_subitem = -1;
static gint hf_s7comm_item_varspec = -1;
static gint hf_s7comm_item_varspec_length = -1;
static gint hf_s7comm_item_syntax_id = -1;
static gint hf_s7comm_item_transport_size = -1;
static gint hf_s7comm_item_length = -1;
static gint hf_s7comm_item_db = -1;
static gint hf_s7comm_item_area = -1;
static gint hf_s7comm_item_address = -1;
static gint hf_s7comm_item_address_byte = -1;
static gint hf_s7comm_item_address_bit = -1;
static gint hf_s7comm_item_address_nr = -1;
static gint hf_s7comm_item_dbread_numareas = -1;
static gint hf_s7comm_item_dbread_length = -1;
static gint hf_s7comm_item_dbread_db = -1;
static gint hf_s7comm_item_dbread_startadr = -1;
static gint hf_s7comm_item_driveesany_unknown1 = -1;
static gint hf_s7comm_item_driveesany_unknown2 = -1;
static gint hf_s7comm_item_driveesany_unknown3 = -1;
static gint hf_s7comm_item_driveesany_parameter_nr = -1;
static gint hf_s7comm_item_driveesany_parameter_idx = -1;
static gint hf_s7comm_item_nck_areaunit = -1;
...
static gint hf_s7comm_data_returncode = -1;
static gint hf_s7comm_data_transport_size = -1;
static gint hf_s7comm_data_length = -1;
...
static gint hf_s7comm_data_ts_year1 = -1;
static gint hf_s7comm_data_ts_year2 = -1;
...
static gint hf_s7comm_ud_blockinfo_block_type = -1;
static gint hf_s7comm_ud_blockinfo_block_num = -1;
static gint hf_s7comm_ud_blockinfo_block_cnt = -1;
static gint hf_s7comm_ud_blockinfo_block_flags = -1;
static gint hf_s7comm_ud_blockinfo_block_lang = -1;
static gint hf_s7comm_ud_blockinfo_block_num_ascii = -1;
static gint hf_s7comm_ud_blockinfo_filesys = -1;
static gint hf_s7comm_ud_blockinfo_res_infolength = -1;
static gint hf_s7comm_ud_blockinfo_res_unknown2 = -1;
static gint hf_s7comm_ud_blockinfo_res_const3 = -1;
static gint hf_s7comm_ud_blockinfo_res_unknown = -1;
static gint hf_s7comm_ud_blockinfo_subblk_type = -1;
static gint hf_s7comm_ud_blockinfo_load_mem_len = -1;
static gint hf_s7comm_ud_blockinfo_blocksecurity = -1;
static gint hf_s7comm_ud_blockinfo_interface_timestamp = -1;
static gint hf_s7comm_ud_blockinfo_code_timestamp = -1;
static gint hf_s7comm_ud_blockinfo_ssb_len = -1;
static gint hf_s7comm_ud_blockinfo_add_len = -1;
static gint hf_s7comm_ud_blockinfo_localdata_len = -1;
static gint hf_s7comm_ud_blockinfo_mc7_len = -1;
static gint hf_s7comm_ud_blockinfo_author = -1;
static gint hf_s7comm_ud_blockinfo_family = -1;
static gint hf_s7comm_ud_blockinfo_headername = -1;
static gint hf_s7comm_ud_blockinfo_headerversion = -1;
static gint hf_s7comm_ud_blockinfo_checksum = -1;
static gint hf_s7comm_ud_blockinfo_reserved1 = -1;
static gint hf_s7comm_ud_blockinfo_reserved2 = -1;
static gint hf_s7comm_userdata_blockinfo_flags = -1;
static gint hf_s7comm_userdata_blockinfo_linked = -1;
static gint hf_s7comm_userdata_blockinfo_standard_block = -1;
static gint hf_s7comm_userdata_blockinfo_nonretain = -1;
...
static const value_string tis_param2_names[] = {
...
static gint hf_s7comm_diagdata_registerflag = -1;
static gint hf_s7comm_diagdata_registerflag_stw = -1;
static gint hf_s7comm_diagdata_registerflag_accu1 = -1;
static gint hf_s7comm_diagdata_registerflag_accu2 = -1;
static gint hf_s7comm_diagdata_registerflag_ar1 = -1;
static gint hf_s7comm_diagdata_registerflag_ar2 = -1;
static gint hf_s7comm_diagdata_registerflag_db1 = -1;
static gint hf_s7comm_diagdata_registerflag_db2 = -1;
...
static gint hf_s7comm_piservice_unknown1 = -1;
...
static gint hf_s7comm_data_plccontrol_argument = -1;
static gint hf_s7comm_data_plccontrol_block_cnt = -1;
static gint hf_s7comm_data_pi_inse_unknown = -1;
static gint hf_s7comm_data_plccontrol_part2_len = -1;
static gint hf_s7comm_data_blockcontrol_unknown1 = -1;
static gint hf_s7comm_data_blockcontrol_errorcode = -1;
static gint hf_s7comm_data_blockcontrol_uploadid = -1;
static gint hf_s7comm_data_blockcontrol_file_ident = -1;
static gint hf_s7comm_data_blockcontrol_block_type = -1;
static gint hf_s7comm_data_blockcontrol_block_num = -1;
static gint hf_s7comm_data_blockcontrol_dest_filesys = -1;
static gint hf_s7comm_data_blockcontrol_part2_len = -1;
static gint hf_s7comm_data_blockcontrol_part2_unknown = -1;
static gint hf_s7comm_data_blockcontrol_loadmem_len = -1;
static gint hf_s7comm_data_blockcontrol_mc7code_len = -1;
...
static gint hf_s7comm_varstat_unknown = -1;
static gint hf_s7comm_varstat_item_count = -1;
static gint hf_s7comm_varstat_req_memory_area = -1;
static gint hf_s7comm_varstat_req_repetition_factor = -1;
static gint hf_s7comm_varstat_req_db_number = -1;
static gint hf_s7comm_varstat_req_startaddress = -1;
static gint hf_s7comm_varstat_req_bitpos = -1;
static gint hf_s7comm_cycl_interval_timebase = -1;
static gint hf_s7comm_cycl_interval_time = -1;
static gint hf_s7comm_cycl_function = -1;
static gint hf_s7comm_cycl_jobid = -1;
static gint hf_s7comm_rdrec_mlen = -1;
static gint hf_s7comm_rdrec_index = -1;
static gint hf_s7comm_rdrec_id = -1;
static gint hf_s7comm_rdrec_statuslen = -1;
static gint hf_s7comm_rdrec_statusdata = -1;
static gint hf_s7comm_rdrec_recordlen = -1;
static gint hf_s7comm_rdrec_data = -1;
static gint hf_s7comm_rdrec_reserved1 = -1;
static gint hf_s7comm_pbc_unknown = -1;
static gint hf_s7comm_pbc_bsend_r_id = -1;
...
static gint ett_s7comm = -1;
static gint ett_s7comm_header = -1;
static gint ett_s7comm_param = -1;
static gint ett_s7comm_param_item = -1;
static gint ett_s7comm_param_subitem = -1;
static gint ett_s7comm_data = -1;
static gint ett_s7comm_data_item = -1;
static gint ett_s7comm_item_address = -1;
static gint ett_s7comm_cpu_alarm_message = -1;
static gint ett_s7comm_cpu_alarm_message_object = -1;
static gint ett_s7comm_cpu_alarm_message_timestamp = -1;
static gint ett_s7comm_cpu_alarm_message_associated_value = -1;
static gint ett_s7comm_cpu_diag_msg = -1;
...
if (flags & 0x01)
 (void) g_strlcat(str, "STW, ", max);
if (flags & 0x02)
 (void) g_strlcat(str, "ACCU1, ", max);
if (flags & 0x04)
 (void) g_strlcat(str, "ACCU2, ", max);
if (flags & 0x08)
 (void) g_strlcat(str, "AR1, ", max);
if (flags & 0x10)
 (void) g_strlcat(str, "AR2, ", max);
if (flags & 0x20)
 (void) g_strlcat(str, "DB1, ", max);
if (flags & 0x40)
 (void) g_strlcat(str, "DB2, ", max);
if (strlen(str) > 2)
str[strlen(str) - 2 ] = '\0';
}
static guint32
...
offset += 1;
area = tvb_get_guint8(tvb, offset + 4);
